...
**Status (2026-09-26): live.** The container runs commit `3ebb04e` (the cozy-room batch), and the owner has created the NPM proxy host. All 9 cross-browser smoke runs pass against `https://tabletop.murri.me`.
